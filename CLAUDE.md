...
- **Número primeiro, marca depois** (eixo, reforçado 2026-09-15): o número abre a conversa, a marca aprofunda a decisão. Quando fizer sentido, a comunicação começa por dá lucro, quanto sobra, quanto custa, quanto cobrar, quanto precisa entrar, meta, preço, dinheiro, decisão — a marca entra depois pra explicar posicionamento, diferenciação, valor percebido, identidade, construção de longo prazo. O número dá chão pra decisão; a marca dá sentido pro que está sendo construído. Nunca inverter pra "marca primeiro".
...
- **Quem fala em mensagem de sistema (2026-08-17).** Todo aviso, erro e confirmação do produto fala pela empresa no plural: "Não conseguimos salvar", nunca "Não consegui". O par coloquial é "a gente", que carrega a parte que tranquiliza ("Não conseguimos salvar. Tenta de novo, a gente guarda tudo."). A primeira pessoa do singular não deve ser usada pela Pólia como empresa nem pela Aimer como se fosse pessoa real — é reservada à Sil falando como pessoa, e só existe em `/sobre`, `/lista-de-espera` e no bloco de contato da `/ajuda` (quando a comunicação estiver explicitamente em nome da Sil), além de relatos pessoais assinados por ela. Não varrer esses lugares para o plural.
