...
export function PoliaFooter() {
  ...
  return (
    <footer role="contentinfo" className="bg-polia-noite px-6 py-10 text-center md:px-12">
      <div className="mx-auto flex max-w-[1280px] flex-col items-center gap-4">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 font-sans text-[12px] text-polia-creme/55">
          <a href="/painel" className="hover:text-polia-creme">
            painel
          </a>
          <span aria-hidden>·</span>
          <a href="/configuracoes" className="hover:text-polia-creme">
            configurações
          </a>
          <span aria-hidden>·</span>
          <a href="/ajuda" className="hover:text-polia-creme">
            ajuda
          </a>
          <span aria-hidden>·</span>
          <a href="/privacidade" className="hover:text-polia-creme">
            privacidade
          </a>
          <span aria-hidden>·</span>
          <a href="/termos" className="hover:text-polia-creme">
            termos
          </a>
        </div>
