  ...
  head: () => ({
    meta: [
      { title: "Como funciona · Pólia" },
      {
        name: "description",
        content:
          "11 etapas em 4 fases. Perguntas guiadas, IA de apoio e entregáveis que ficam com você.",
      },
      { property: "og:title", content: "Como funciona · Pólia" },
      {
        property: "og:description",
        content: "Uma jornada estruturada para o seu negócio, no seu ritmo.",
      },
    ],
  }),
...
const ETAPAS = [
  ...
  { n: 2, fase: "SONHO", cor: "#C9407A", nome: "Sua voz", entregavel: "Voz de marca" },
  {
    ...
    fase: "SONHO",
    cor: "#C9407A",
    nome: "Seu lugar no mercado",
    entregavel: "Mapa de posicionamento",
  },
  { n: 4, fase: "CONSTRUÇÃO", cor: "#1A7FAD", nome: "Seu produto", entregavel: "Ficha de produto" },
  {
    ...
    cor: "#1A7FAD",
    nome: "Sua presença",
    entregavel: "Guia de primeira impressão",
  },
  {
    n: 6,
    fase: "CONSTRUÇÃO",
    cor: "#1A7FAD",
    nome: "Seu controle",
    entregavel: "Sistema de controle",
  },
  ...
  { n: 9, fase: "VENDA", cor: "#1A8F5C", nome: "Seu conteúdo", entregavel: "Plano de conteúdo" },
  {
    ...
    cor: "#6B50CC",
    nome: "Seus números",
    entregavel: "Painel de 3 números",
  },
      ...
      <section className="bg-[#1A1A2E] py-24 text-center">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="font-sans text-[#FDF8F5]/70 text-[17px] leading-relaxed">
            A Pólia estrutura seu negócio em 11 etapas organizadas em 4 fases. Cada etapa tem
            perguntas guiadas, IA de apoio e um entregável que fica na sua biblioteca.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#FDF8F5] py-24">
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            {
              num: "01",
              titulo: "Perguntas certas",
              texto:
                "Cada etapa traz perguntas pensadas pra quem está começando — sem jargão, sem enrolação. Você pensa, você responde.",
            },
            {
              num: "02",
              titulo: "IA que processa",
              texto:
                "Suas respostas viram entregáveis concretos: um pitch, uma ficha de produto, um roteiro de vendas. Gerados com o que você mesma escreveu.",
            },
            {
              num: "03",
              titulo: "Ferramentas vivas",
              texto:
                "Os entregáveis se organizam em 4 ferramentas vivas — hubs que crescem com você. Sempre à mão.",
            },
          ].map((item) => (
            <div key={item.num}>
              ...
              <p className="font-sans text-[#1A1A2E]/65 text-[15px] leading-relaxed">
                {item.texto}
              </p>
            </div>
          ))}
            ...
            {ETAPAS.map((item, i) => (
              <div key={item.n} className="flex gap-6 items-start">
                <div className="flex flex-col items-center">
                  ...
                  {i < ETAPAS.length - 1 && (
                    <div className="w-px flex-1 bg-[#1A1A2E]/15 min-h-[40px]" />
                  )}
                </div>
                <div className="pb-6 flex-1">
                  <p
                    className="font-sans font-semibold text-[11px] uppercase tracking-wider mb-1"
