    ...
    <>
            ...
            >
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="font-sans text-[#1A1A2E] text-[13px] opacity-50 mt-1 whitespace-pre-wrap">
                    {c.mensagem}
                  </p>
                </div>
                <a
      ...
      <div className="bg-white rounded-2xl p-7 border border-[rgba(26,26,46,0.06)]">
        ...
        <p className="font-sans text-[#1A1A2E] text-[13px] opacity-50 mb-4">
          Em breve. A flag <code className="font-mono text-[12px]">broadcast_ativo</code> precisa
          estar ligada e o Resend configurado.
        </p>
      </div>
    </>
  );
