...
function HeadlineDuas({ a, b }: { a: string; b: string }) {
  return (
    <div className="font-serif text-[#1A1A2E] text-[40px] md:text-[48px] leading-[1.2] mt-3">
      <p>{a}</p>
      <p>{b}</p>
    </div>
  );
  ...
  return (
    <div className="min-h-screen w-full bg-[#FDF8F5]">
      ...
      <div className="mx-auto max-w-[860px] px-6 py-16">
        ...
        <h2 className="font-serif text-[#1A1A2E] text-[42px] md:text-[48px] leading-[1.2] text-center mt-2">
