...
export const Route = createFileRoute("/_authenticated/etapa/2")({
  ...
  beforeLoad: async () => {
    ...
    const { data: profile } = await supabase
      .from("profiles")
      .select("etapa_atual, star_2_completed_at")
      .eq("id", uid)
      .maybeSingle();
    if (!profile) return;
    if ((profile.etapa_atual ?? 1) < 2) {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 py-10 md:py-16 text-center">
        ...
        <p className="font-handwritten text-[#E89770] text-[26px] mt-10">agora vamos dar forma.</p>
...
function PerguntaLayout({
  ...
  return (
    <div className="min-h-screen w-full bg-[#FDF8F5]">
      ...
      <EtapaTopBar etapa={2} fase="SONHO" nome="Identidade" variant="dark" />
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 py-10 md:py-16 text-center">
        ...
        {!loading && !error && voz && (
          <>
            ...
            <p className="font-handwritten text-[#E89770] text-[28px] mt-4">olha o que a gente fez juntas.</p>
            ...
            <div className="mt-10 w-full max-w-[820px] rounded-[20px] border border-[rgba(200,169,110,0.3)] bg-[#FAF4EF] p-8 text-left">
                  ...
                  return (
                    <button
                      ...
                      className={`h-[28px] rounded-[14px] px-3 font-sans text-[11px] ${
                        ativo
                          ? "bg-[#C96B3E] font-semibold text-[#FDF8F5]"
              ...
              <p className="font-handwritten text-[rgba(232,151,112,0.85)] text-[15px] mt-5 text-center">
...
function Conclusao({ onVerPainel, onEtapa3 }: { onVerPainel: () => void; onEtapa3: () => void }) {
  const estrelas = [
    ...
    { n: 2, label: "Identidade", estado: "agora" },
    { n: 3, label: "Modelo", estado: "dim" },
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-[1100px] flex-col items-center px-6 py-20 text-center">
        <p className="font-accent text-[11px] font-bold tracking-[2.5px] text-[rgba(200,169,110,0.9)]">
          ETAPA 2 · IDENTIDADE DO SEU NEGÓCIO · CONCLUÍDA
        </p>

        <p className="font-handwritten text-[#E89770] text-[28px] mt-10">olha o que aconteceu agora.</p>
