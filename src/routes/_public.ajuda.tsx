...
const FAQ = [
  { pergunta: "O que é a Pólia?", resposta: "A Pólia é uma plataforma guiada pra mulheres empreendedoras que querem estruturar seu negócio. São 11 etapas com perguntas, IA de apoio e entregáveis reais que ficam salvos pra você usar pra sempre." },
