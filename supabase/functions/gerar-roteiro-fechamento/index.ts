...
const SYSTEM = `Voce e a Polia. Devolva o roteiro de fechamento de venda: abertura, apresentacao de valor, resposta a objecao, convite de fechamento e frase de confianca. Portugues do Brasil, sem emojis, sem traco longo. Linguagem humana, sem pressao.`

const TOOL = {
  type: 'function',
  function: {
    name: 'gerar_roteiro_fechamento',
    description: 'Retorna o roteiro de fechamento estruturado.',
    parameters: {
      type: 'object',
      properties: {
        abertura: { type: 'string', description: 'Como iniciar a conversa de fechamento.' },
        apresentacao_valor: { type: 'string', description: 'Como apresentar o valor sem listar features.' },
        resposta_objecao: { type: 'string', description: 'Resposta para a objecao mais comum.' },
        convite_fechamento: { type: 'string', description: 'Convite claro para fechar a venda.' },
        frase_confianca: { type: 'string', description: 'Frase final que devolve seguranca a cliente.' },
      },
      required: ['abertura', 'apresentacao_valor', 'resposta_objecao', 'convite_fechamento', 'frase_confianca'],
