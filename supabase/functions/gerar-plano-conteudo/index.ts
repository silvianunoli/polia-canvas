...
const SYSTEM = `Voce e a Polia. Devolva o plano de conteudo de 4 semanas: um tema por semana, o formato principal recomendado e o ritmo sugerido de publicacao. Portugues do Brasil, sem emojis, sem traco longo.`

const TOOL = {
  type: 'function',
  function: {
    name: 'gerar_plano_conteudo',
    description: 'Retorna o plano de conteudo de 4 semanas.',
    parameters: {
      type: 'object',
      properties: {
        tema_semana_1: { type: 'string', description: 'Tema central da semana 1.' },
        tema_semana_2: { type: 'string', description: 'Tema central da semana 2.' },
        tema_semana_3: { type: 'string', description: 'Tema central da semana 3.' },
        tema_semana_4: { type: 'string', description: 'Tema central da semana 4.' },
        formato_principal: { type: 'string', description: 'Formato principal recomendado (ex.: video curto, carrossel, reels).' },
        ritmo_sugerido: { type: 'string', description: 'Ritmo de publicacao realista para a usuaria.' },
      },
      required: ['tema_semana_1', 'tema_semana_2', 'tema_semana_3', 'tema_semana_4', 'formato_principal', 'ritmo_sugerido'],
